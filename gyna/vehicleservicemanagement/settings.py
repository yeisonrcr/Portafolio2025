...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'ecotrabajo8@gmail.com' # this email will be used to send emails
EMAIL_HOST_PASSWORD = '.zbYja8918k.' 

EMAIL_RECEIVING_USER = ['ecotrabajo8@gmail.com'] # email on which you will receive messages sent from website

...
from .models import Tienda, Producto, Categoria, Carrito, ItemCarrito, Provincia, Canton,Distrito,ItemOrden, Orden
...
class ItemCarritoAdmin(admin.ModelAdmin):
    list_display = ('numero_orden', 'usuario', 'tienda', 'monto_total', 'subtotal')
    list_filter = ('carrito__tienda', 'producto__categoria')
    search_fields = ('producto__nombre', 'carrito__usuario__username')
